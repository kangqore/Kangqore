...
export const ENTERPRISE_OBJECTS: EnterpriseObjectDef[] = [
  ...
  { name: 'Portfolio', displayName: 'Portfolio', icon: 'Briefcase', color: '#6366f1', tier: 4,
    extra: {
      budget: { type: 'number', description: 'Total funded amount across the portfolio', columnClass: 'ENTERPRISE', label: 'Budget', columnType: 'number', order: 5 },
      horizon: { type: 'select', description: 'Planning horizon', columnClass: 'ENTERPRISE', label: 'Horizon', columnType: 'badge', options: ['QUARTER', 'YEAR', 'MULTI_YEAR'], order: 6 },
    },
    description: 'A funded grouping of programs the business plans and reports on together.' },
  { name: 'Program', displayName: 'Program', icon: 'Layers', color: '#0ea5e9', tier: 5,
    description: 'A coordinated set of projects.' },
  { name: 'Project', displayName: 'Project', icon: 'FolderKanban', color: '#3b82f6', tier: 6,
  ...
  { name: 'Workstream', displayName: 'Workstream', icon: 'GitBranch', color: '#14b8a6', tier: 7,
    description: 'A parallel track of delivery inside a project.' },
  { name: 'Task', displayName: 'Task', icon: 'CheckSquare', color: '#22c55e', tier: 8,
  ...
  { name: 'Action', displayName: 'Action', icon: 'Zap', color: '#84cc16', tier: 9,
    description: 'A single governed step executed by a human or an agent.' },
  { name: 'Evidence', displayName: 'Evidence', icon: 'FileCheck', color: '#64748b', tier: 10,
    description: 'Proof that an action produced its intended result.' },
  { name: 'Outcome', displayName: 'Outcome', icon: 'Trophy', color: '#f59e0b', tier: 11,
...
export const ENTERPRISE_RELATIONSHIPS: RelationshipDef[] = [
  ...
  { sourceType: 'Program',            targetType: 'Portfolio',          relationshipType: 'partOf',      cardinality: 'MANY_TO_ONE', description: 'Program rolls up into a portfolio' },
  { sourceType: 'Portfolio',          targetType: 'StrategicObjective', relationshipType: 'serves',      cardinality: 'MANY_TO_ONE', description: 'Portfolio serves an objective' },
  { sourceType: 'Portfolio',          targetType: 'Employee',           relationshipType: 'ownedBy',     cardinality: 'MANY_TO_ONE', description: 'Portfolio owned by a person' },
