...
export const CLIENTS: Client[] = [
  {
    ...
    owner: 'Mahesh Kumar', projectIds: ['pj1'], satisfactionScore: 78, lastActivity: '2026-05-27',
...
export const INTERACTIONS: Interaction[] = [
  { id: 'i1',  clientId: 'c1', type: 'meeting',   title: 'Sprint 4 Review',              summary: 'Demoed email integration and lead scoring. Client happy with progress. Requested CSV export by next sprint.',           date: '2026-05-26', owner: 'Mahesh Kumar' },
  { id: 'i2',  clientId: 'c1', type: 'email',     title: 'Invoice KQ-2026-004 sent',     summary: 'Sent £44k invoice for Sprint 3-4 work. 30-day payment terms.',                                                          date: '2026-04-30', owner: 'Mahesh Kumar' },
  ...
  { id: 'i6',  clientId: 'c2', type: 'meeting',   title: 'Portal delivery review',       summary: 'Task board live, earnings dashboard 60% done. Client raised new requirement for bulk export — logged as change request.',date: '2026-05-12', owner: 'Mahesh Kumar' },
  ...
  { id: 'i8',  clientId: 'c3', type: 'note',      title: 'Upsell opportunity noted',     summary: 'Meridian interested in automated reporting + investor portal. Potential £45k expansion. Flagged to Mahesh.',            date: '2026-05-25', owner: 'Priya Sharma' },
  ...
  { id: 'i10', clientId: 'c4', type: 'call',      title: 'Contract signed — onboarding', summary: 'Signed £220k contract. GlobeMed is our largest client. KOM scheduled for June 1.',                                    date: '2026-05-28', owner: 'Mahesh Kumar' },
...
export const MILESTONES: Milestone[] = [
  ...
  { id: 'm5',  clientId: 'c1', projectId: 'pj1', title: 'Go-live & handover',                 description: 'Production deploy, training, documentation.',       dueDate: '2026-07-31', status: 'upcoming',    owner: 'Mahesh Kumar' },
  { id: 'm6',  clientId: 'c2', projectId: 'pj3', title: 'Phase 1 — Task board',              description: 'Partner task board and basic dashboard.',           dueDate: '2026-04-01', completedDate: '2026-04-01', status: 'completed',   owner: 'Mahesh Kumar' },
...
export const GOVERNANCE: GovernanceItem[] = [
  { id: 'g1',  clientId: 'c1', type: 'change-request', title: 'Add CSV export to lead list',         description: 'Client requests bulk CSV export with custom field mapping.',   status: 'approved', owner: 'Mahesh Kumar', date: '2026-05-26', priority: 'medium', resolution: 'Approved in scope, added to Sprint 3 backlog. No cost impact.' },
  { id: 'g2',  clientId: 'c1', type: 'decision',       title: 'Push go-live to July 15',             description: 'Go-live moved from July 1 to July 15 at client request.',     status: 'approved', owner: 'Mahesh Kumar', date: '2026-05-10', priority: 'high',   resolution: 'Timeline extended by 2 weeks. No additional cost.' },
  { id: 'g3',  clientId: 'c1', type: 'steering',       title: 'Q2 steering committee',               description: 'Quarterly review of delivery, budget, and roadmap alignment.',status: 'closed',   owner: 'Mahesh Kumar', date: '2026-04-15', priority: 'medium', resolution: 'All Q2 milestones confirmed. Budget on track at 54%.' },
  ...
  { id: 'g6',  clientId: 'c2', type: 'decision',       title: 'Phase 2 delay — scope vs timeline',  description: 'Phase 2 delayed 2 weeks — choose: cut scope or extend timeline.', status: 'open',  owner: 'Mahesh Kumar', date: '2026-05-18', priority: 'high' },
  ...
  { id: 'g8',  clientId: 'c3', type: 'decision',       title: 'Upsell: investor portal scope',       description: 'Meridian interested in £45k expansion for investor reporting.', status: 'pending', owner: 'Mahesh Kumar', date: '2026-05-25', priority: 'high' },
