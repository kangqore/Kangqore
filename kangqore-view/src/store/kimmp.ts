...
export const KIMMP_MOCK: Insight[] = [
  {
    id: 'k1', category: 'revenue', priority: 'critical', module: 'Leads', confidence: 84, impact: '£320k ARR',
  ...
  {
    id: 'k2', category: 'risk', priority: 'critical', module: 'Finance', confidence: 91, impact: 'Budget risk £18k',
  ...
  {
    id: 'k3', category: 'opportunity', priority: 'high', module: 'Clients', confidence: 71, impact: '£45k–85k upsell',
  ...
  {
    id: 'k4', category: 'talent', priority: 'high', module: 'Careers', confidence: 77, impact: '8-week hiring delay',
  ...
  {
    id: 'k5', category: 'ops', priority: 'medium', module: 'Finance', confidence: 98, impact: '£42k cash at risk',
  ...
  {
    id: 'k6', category: 'opportunity', priority: 'medium', module: 'Investors', confidence: 88, impact: '£5M Series A risk',
  ...
  {
    id: 'k7', category: 'revenue', priority: 'high', module: 'Leads', confidence: 67, impact: '£95k ARR',
  ...
  {
    id: 'k8', category: 'ops', priority: 'low', module: 'Projects', confidence: 74, impact: 'Timeline risk',
