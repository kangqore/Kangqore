...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'os-xs':   ['0.625rem', { lineHeight: '1rem',    letterSpacing: '0.04em'  }],
        'os-sm':   ['0.75rem',  { lineHeight: '1.125rem', letterSpacing: '0.01em' }],
        'os-base': ['0.875rem', { lineHeight: '1.375rem', letterSpacing: '0'      }],
        'os-md':   ['1rem',     { lineHeight: '1.5rem',   letterSpacing: '-0.01em'}],
        'os-lg':   ['1.25rem',  { lineHeight: '1.5rem',   letterSpacing: '-0.02em'}],
        'os-xl':   ['1.75rem',  { lineHeight: '2rem',     letterSpacing: '-0.03em'}],
      },
