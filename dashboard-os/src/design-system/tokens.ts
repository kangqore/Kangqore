...
export const shadow = {
  ...
  glow: '0 0 25px -5px rgba(37, 100, 234, 0.15), 0 8px 20px -6px rgba(37, 100, 234, 0.1)',
  glowGreen: '0 0 25px -5px rgba(34, 197, 94, 0.15), 0 8px 20px -6px rgba(34, 197, 94, 0.1)',
  glass: '0 8px 32px 0 rgba(15, 17, 23, 0.04), backdrop-filter blur(8px)',
} as const
