...
export const LEADS: Lead[] = [
  { id: 'l1',  company: 'Apex Ventures',        contactName: 'Marcus Reid',      contactRole: 'CTO',               email: 'marcus@apexventures.io',   phone: '+44 7700 111001', country: 'UK',          industry: 'VC / PE',            stage: 'proposal',    source: 'eQORE',    score: 84, value: 280000, probability: 60, owner: 'Mahesh Kumar',  createdAt: '2026-03-10', lastActivity: '2026-05-27', tags: ['high-value','investor-portal','ai'],          description: 'Apex wants a full investment management OS. eQORE flagged as top-tier ICP match.'  },
  ...
  { id: 'l7',  company: 'NovaCare Pharma',       contactName: 'Dr. Erik Larsson', contactRole: 'Head of Digital',    email:'elarsson@novacare.se',      phone: '+46 70 123 4567', country: 'Sweden',      industry: 'Pharma',             stage: 'new',         source: 'event',    score: 55, value: 120000, probability: 25, owner: 'Mahesh Kumar',  createdAt: '2026-05-15', lastActivity: '2026-05-15', tags: ['pharma','compliance','data'],                 description: 'Met at HealthTech Europe. Interested in data governance and compliance tools.'     },
