  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // ── OS design tokens (new) ──
        'os-bg':       'var(--os-bg)',
        'os-s0':       'var(--os-surface-0)',
        'os-s1':       'var(--os-surface-1)',
        'os-s2':       'var(--os-surface-2)',
        'os-s3':       'var(--os-surface-3)',
        'os-border':   'var(--os-border)',
        'os-blue':     'var(--os-blue)',
        'os-cyan':     'var(--os-cyan)',
        'os-text-1':   'var(--os-text-1)',
        'os-text-2':   'var(--os-text-2)',
        'os-text-3':   'var(--os-text-3)',
        'os-text-4':   'var(--os-text-4)',
        'os-text-5':   'var(--os-text-5)',
