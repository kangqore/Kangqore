  ...
  useEffect(() => {
    const fetchBlog = async () => {
      try {
        ...
        const response = await fetch(`${process.env.REACT_APP_BACKEND_URL || 'http://localhost:5050'}/api/content/${slug}`);
        ...
        try {
          ...
          if (!sessionStorage.getItem(viewedKey)) {
             await axios.post(`${process.env.REACT_APP_BACKEND_URL || 'http://localhost:5050'}/api/admin/content/track/view`, {
               contentId: data.id,
