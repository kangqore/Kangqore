...
import { MessageSquare, Send, Paperclip, Search, FileText, X, Link as LinkIcon, Flag } from 'lucide-react';
...
const AdminMessages = () => {
  ...
  const [selectedChatUser, setSelectedChatUser] = useState(null); // The User ID we are chatting with
  ...
  const handleSendMessage = async (e) => {
    ...
    const payload = {
      ...
      receiverId: selectedChatUser, // Explicitly sending to this user
    ...
    try {
      ...
      fetchMessages(selectedChatUser); // Sync
    } catch (error) {
  ...
  return (
    <DashboardLayout role="admin" title="Messages" subtitle="Support Inbox">
                ...
                {/* Header */}
                 <div className="p-4 border-b border-gray-200 flex items-center justify-between bg-white dark:bg-gray-900 dark:border-gray-800">
                    <div className="flex items-center gap-3">
                         ...
                         {/* Gap Closure: Outcome Mapping & Delay Attribution */}
                         <div className="ml-4 flex gap-2">
                            <button className="text-[10px] flex items-center gap-1 bg-white dark:bg-gray-900 dark:border-gray-800 border border-gray-200 px-2 py-1 rounded hover:bg-gray-50 text-gray-600 dark:text-gray-400 font-bold" title="Link to Decision/Outcome">
                                <LinkIcon className="w-3 h-3" /> Link Outcome
                            </button>
                            <button className="text-[10px] flex items-center gap-1 bg-white dark:bg-gray-900 dark:border-gray-800 border border-red-100 text-red-600 px-2 py-1 rounded hover:bg-red-50 font-bold" title="Attribute Delay to this Thread">
                                <Flag className="w-3 h-3" /> Attribute Delay
                            </button>
                         </div>
                    </div>
                 </div>
