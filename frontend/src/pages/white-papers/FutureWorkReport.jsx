...
const FutureWorkReport = () => {
  const wp = whitePapersData.find(w => w.slug === 'future-work-report');
  const wpIndex = whitePapersData.findIndex(w => w.slug === 'future-work-report');
  ...
  const relatedContent = whitePapersData
    .filter(w => w.slug !== 'future-work-report')
    .slice(0, 4)
  ...
  return (
    <ContentDetailLayout
      ...
      authorBio="This report examines how technology is reshaping the modern workplace and provides guidance for organizations navigating workforce transformation."
      tags={wp.topics}
    ...
    >
      ...
      <p>The workplace is undergoing fundamental transformation driven by technology, changing employee expectations, and new ways of working. This report examines key trends and provides guidance for leaders.</p>

      <h2>Key Themes</h2>
      <ul>
        <li><strong>Hybrid Work:</strong> Designing effective hybrid work models</li>
        <li><strong>AI Augmentation:</strong> How AI is changing job roles and skills</li>
        <li><strong>Digital Collaboration:</strong> Tools and practices for distributed teams</li>
        <li><strong>Employee Experience:</strong> Building engagement in the digital workplace</li>
      </ul>
    </ContentDetailLayout>
  );
};

export default FutureWorkReport;
