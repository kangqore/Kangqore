...
import { ArrowLeft, ArrowRight, Settings, Users, Workflow, Zap, Target } from 'lucide-react';
import { Link } from 'react-router-dom';

const OperatingModelReinvention = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-black pt-24 text-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-8 font-display">Operating Model Reinvention</h1>
        <p className="text-xl text-slate-600 dark:text-gray-400 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
          ...
          Kangqore redesigns operating models to support agile execution, DevSecOps maturity, and data-driven decision systems.
        </p>
...
export default OperatingModelReinvention;
