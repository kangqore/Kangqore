          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-4">
              {[
                ...
                { name: 'Modernization Infrastructure', link: '/services/infrastructure-networks-operations/infrastructure-modernization', icon: <Server className="w-5 h-5" />, desc: 'Modernize legacy debt into a scalable digital core.' }
              ].map((e, idx) => (
