            ...
            <div className="max-w-7xl mx-auto px-6 py-6 grid grid-cols-2 gap-4">
              {[
                ...
                <div key={s.label} className="text-center">
                  ...
                  <p className="text-[11px] bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent font-bold tracking-widest uppercase mt-1">{s.label}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-start mb-20">
            ...
            <div className="space-y-4">
              ...
              <div className="p-8 border border-white/[0.08] bg-[#06090f] rounded-2xl">
                <p className="text-[11px] font-black tracking-[0.4em] bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent uppercase mb-4">THE SOLUTION</p>
                <p className="text-white font-semibold text-lg leading-snug">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
                  ...
                  >
                    <div className="flex items-center justify-between gap-4 mb-2">
                      <div className="flex items-center gap-4">
                        <Icon className={`w-4 h-4 flex-shrink-0 transition-colors ${isOpen ? 'text-[#2564ea]' : 'text-white/50'}`} />
                    ...
                    {isOpen && (
                      <div className="pl-8 pt-1">
                        <p className="text-[11px] font-black tracking-[0.3em] bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent uppercase mb-2">{f.label}</p>
            ...
            <div className="lg:sticky lg:top-8">
              <div className="p-8 rounded-2xl border border-white/[0.07] bg-[#06090f]">
                ...
                <p className="text-[11px] font-black tracking-widest uppercase mb-2 bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent">
                ...
                <div className="p-4 rounded-xl border border-cyan-400/20 bg-cyan-400/[0.04]">
                  <p className="text-sm font-semibold leading-snug bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent">
      ...
      <div className="py-14 border-t border-white/[0.05]" style={{ backgroundColor: '#000000' }}>
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 p-8 rounded-2xl border border-white/[0.07] bg-[#06090f]">
            <div>
              <p className="text-[11px] font-black tracking-[0.4em] bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent uppercase mb-3">READY TO EXPLORE A DESIGN ENGAGEMENT?</p>
          ...
          <div className="grid lg:grid-cols-2 lg:gap-24 lg:h-[700px]">
            ...
            <div className="hidden lg:flex items-start pt-5">
              <div className="w-full sticky top-8">
                <p className="text-[11px] font-black tracking-[0.35em] bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent uppercase mb-6">
      ...
      <section className="py-24 border-t border-white/[0.05] relative overflow-hidden" style={{ backgroundColor: '#000000' }}>
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div ref={differentiatorRef} className="max-w-5xl mx-auto">
            <p className="text-[11px] font-black tracking-[0.45em] bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent uppercase mb-8">WHY THIS APPROACH</p>
            <div className="space-y-3">
              {differentiators.map((d) => (
                <div key={d.num} className="diff-item group flex items-start gap-5 p-6 bg-[#06090f] rounded-2xl border border-white/[0.07] hover:border-white/[0.15] transition-all duration-300 relative overflow-hidden">
                  ...
                  <div>
                    <h4 className="font-black text-lg text-white mb-1 group-hover:bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent transition-colors">{d.title}</h4>
                    ...
                    <div key={idx} className="journey-card group">
                      <div className="relative bg-[#06090f] border border-white/[0.08] rounded-3xl p-6 lg:p-8 hover:border-white/[0.18] transition-all duration-500 hover:-translate-y-1 flex items-start gap-6">
                        ...
                        <div className="relative z-10 flex-1 min-w-0">
                          ...
                          <h4 className="text-lg font-black text-white mb-1 group-hover:bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent transition-colors duration-300">{item.title}</h4>
              ...
              {relatedServices.map((e) => {
                ...
                return (
                  <Link key={e.name} to={e.link} className="group flex items-start gap-5 p-6 bg-[#06090f] border border-white/[0.07] rounded-2xl hover:border-white/[0.18] transition-all">
                    <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent group-hover:bg-cyan-400/10 transition-all flex-shrink-0">
                      <Icon className="w-5 h-5" />
                    </div>
                    <div>
                      <span className="font-black text-lg text-white block mb-1 group-hover:bg-gradient-to-r from-[#2564ea] to-[#4ab6d4] bg-clip-text text-transparent transition-colors">{e.name}</span>
                      <p className="text-white/50 text-sm">{e.desc}</p>
                    </div>
                    <ArrowRight className="w-4 h-4 text-white/20 group-hover:text-[#2564ea] group-hover:translate-x-1 transition-all mt-1 flex-shrink-0 ml-auto" />
                  </Link>
                );
              })}
            </div>
          ...
          <div className="p-10 lg:p-16 rounded-3xl border border-white/[0.08] bg-[#06090f] relative overflow-hidden text-center">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
                ...
                >
                  Explore Capabilities
                  <ArrowRight className="w-4 h-4 text-[#2564ea]" />
                </a>
              </div>
            </div>
          </div>
