...
const InfrastructureCapitalProjects = () => {
  // ============================================
  // SERVICE INFORMATION
  ...
  const service = {
    ...
    slug: 'infrastructure-capital-projects',
    shortDescription: 'Large-scale infrastructure project delivery',
    fullDescription: 'Deliver complex infrastructure and capital projects with expert project management.',
    ...
    highFidelity: {
      narrative: {
        ...
        titleHighlight: 'Infrastructure & Capital Projects.',
        titleLine2: 'At Scale.',
        description: 'We design and deliver Infrastructure & Capital Projects solutions that move beyond incremental improvement — embedding capability, governance, and measurable business value into every engagement.',
        ...
        requirementText: 'Governed, integrated, and outcome-assured Infrastructure & Capital Projects delivery.',
      ...
      philosophy: {
        ...
        description: 'We believe every Infrastructure & Capital Projects engagement should deliver compounding enterprise value — not just deliverables, but lasting organizational capability.',
        pills: ['Outcome-Led', 'Governed', 'Scalable', 'ROI-Focused']
      },
      matrix: {
        engineId: 'Engine :: INFRASTR_V3',
        title: 'Enablement Matrix',
        subtext: 'Our Infrastructure & Capital Projects lifecycle deconstructed into modular, governed, enterprise-grade delivery layers.',
        layers: [
          { title: 'Assess', id: 'INFR_ASSESS', icon: <Search />, desc: 'Discovery, assessment, and strategic alignment.' },
          { title: 'Design', id: 'INFR_DESIGN', icon: <Layers />, desc: 'Architecture design and solution planning.' },
          { title: 'Deliver', id: 'INFR_DEL', icon: <Activity />, desc: 'Structured implementation and delivery.' },
          { title: 'Govern', id: 'INFR_GOV', icon: <ShieldCheck />, desc: 'Governance, monitoring, and continuous optimization.' }
        ]
      },
      schematic: {
        titleLine1: 'Deliver',
        titleHighlight: 'Value.',
        description: 'Your Infrastructure & Capital Projects investment should generate compounding business returns. We engineer the delivery frameworks that make it measurable and sustained.',
        stats: [
  ...
  const additionalInfo = {
    overview: `With deep expertise in infrastructure, networks & operations, we deliver infrastructure & capital projects solutions that drive measurable business outcomes. Our approach combines industry best practices with cutting-edge technology to ensure your success.`,
  ...
  const capabilities = [
    {
      ...
      items: [
        { 
          ...
          description: `Comprehensive analysis of your current state and infrastructure & capital projects requirements to identify opportunities.` 
        },
        { 
        ...
        { 
          ...
          description: `Design scalable and robust infrastructure & capital projects architecture tailored to your needs.` 
        },
        { 
    ...
    },
    {
      ...
      items: [
        { 
          ...
          description: `Iterative development approach ensuring flexibility and rapid delivery of infrastructure & capital projects solutions.` 
        },
        { 
    ...
    },
    {
      ...
      items: [
        { 
          ...
          description: `24/7 monitoring, maintenance, and support to ensure optimal infrastructure & capital projects performance.` 
        },
        { 
        ...
        { 
          ...
          description: `Stay ahead with latest infrastructure & capital projects trends, updates, and innovation initiatives.` 
        }
      ]
    }
  ];
  ...
  const customFAQs = [
    {
      question: `What is Infrastructure & Capital Projects and how can it benefit my organization?`,
      answer: `Infrastructure & Capital Projects helps organizations large-scale infrastructure project delivery. By implementing infrastructure & capital projects, you can improve efficiency, reduce costs, and gain competitive advantage.`
    },
    {
      question: `How long does a typical infrastructure & capital projects project take?`,
    ...
    {
      question: `What industries do you serve for infrastructure & capital projects?`,
  ...
  const whyKangqore = [
    { 
      ...
      description: `Years of experience delivering successful infrastructure & capital projects projects across industries.` 
    },
    { 
...
export default InfrastructureCapitalProjects;
