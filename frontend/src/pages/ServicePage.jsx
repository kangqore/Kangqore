  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <section className="py-20 bg-gray-50 dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4">Tools & Technologies We Excel In</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Leveraging industry-leading technologies to deliver exceptional {service.name.toLowerCase()} solutions
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-4">
            {technologies.map((tech, index) => (
              <span key={index} className="px-6 py-3 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-700 dark:text-gray-300 rounded-full font-medium hover:bg-brand-gradient hover:text-white transition-all duration-300 cursor-pointer shadow-sm">
                {tech}
              </span>
            ))}
          </div>
