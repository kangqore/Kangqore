...
export const servicesData = {
  ...
  'enterprise-integration-platform': {
    ...
    whatIsTitle: 'Enterprise Integration, Architected',
    whatIsHighlightNewLine: true,
    whatIsHighlight: 'as a Business Capability.',
