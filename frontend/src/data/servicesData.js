...
export const servicesData = {
  ...
  'big-data': {
    ...
    capabilitiesSectionTitle: 'Our',
    capabilitiesSectionHighlight: 'Capabilities.',
    capabilitiesLede: 'Understand the estate, connect the data, build the platform, govern it, operate it, migrate off what it replaces — and run it afterwards if you would rather not.',
    capabilityAreas: [
      {
      ...
      {
        title: 'Big Data Modernization & Migration',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Getting off what you are on now — a Hadoop estate, an appliance out of support, a warehouse whose bill has outgrown its usefulness — without losing integrity or continuity on the way.',
        items: [
          'Hadoop Modernization',
      ...
      },
      {
        ...
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Running it after go-live, across cloud, hybrid and on-premise, under an agreed service level. For teams who want the platform without hiring the platform team.',
        items: [
