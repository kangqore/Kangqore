    ...
    capabilityAreas: [
      {
        ...
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Define the enterprise vision, operating model, investment priorities, governance structures, and transformation roadmap required to scale Generative AI across the organization. This capability aligns AI initiatives with business strategy, organizational readiness, operating models, and measurable value creation.',
        items: [
          'GenAI Transformation Strategy: Define enterprise-wide GenAI strategies, priorities, target states, investment themes, and transformation roadmaps aligned with business objectives.',
          'AI Maturity Assessment: Assess organizational AI capabilities, technology readiness, data maturity, governance structures, talent, and operating capabilities to identify transformation priorities and capability gaps.',
          'Operating Model Design: Design the organizational structures, roles, responsibilities, governance mechanisms, decision rights, and operating processes required to manage GenAI at enterprise scale.',
          'Enterprise AI Policy: Establish enterprise policies, standards, principles, and operating guidelines governing the responsible adoption and use of Generative AI.',
          'Portfolio Governance: Establish frameworks to prioritize, govern, monitor, and evaluate GenAI initiatives based on strategic alignment, business value, risk, investment, and execution readiness.',
          'Adoption & Change Management: Enable enterprise adoption through workforce readiness, stakeholder alignment, capability development, training, communications, and organizational change programs.',
        ],
      },
      {
        title: 'Agentic AI & Autonomous Systems',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Engineer autonomous AI systems capable of reasoning, planning, coordinating actions, interacting with enterprise systems, and executing complex workflows with defined levels of autonomy and human oversight.',
        items: [
          'Intelligent Digital Workers: Deploy AI agents capable of performing multi-step business activities, interacting with enterprise applications, processing information, and executing operational tasks.',
          'Multi-Agent Systems: Design coordinated networks of specialized AI agents that collaborate, exchange context, divide responsibilities, validate outputs, and collectively execute complex workflows.',
          'Enterprise AI Copilots: Develop contextual AI assistants that augment employees with knowledge retrieval, analysis, content generation, recommendations, workflow assistance, and decision support.',
          'Autonomous Workflow Automation: Automate complex business workflows through AI systems capable of interpreting objectives, determining actions, executing tasks, and escalating exceptions.',
          'Agent Orchestration: Coordinate AI agents, models, tools, enterprise applications, and workflows through centralized orchestration and policy-controlled execution.',
          'Tool-Using AI Systems: Enable AI systems to securely interact with enterprise APIs, databases, applications, tools, and services to perform actions beyond conversational interaction.',
        ],
      },
      {
        title: 'Enterprise Knowledge & RAG',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Build enterprise knowledge systems that ground Generative AI in trusted organizational information, enabling contextual access to institutional knowledge while maintaining security, relevance, and information governance.',
        items: [
          'Enterprise Knowledge Assistants: Develop AI assistants that provide contextual access to organizational policies, procedures, documents, operational knowledge, and institutional intelligence.',
          'Secure RAG Architectures: Engineer Retrieval-Augmented Generation architectures that connect foundation models with trusted enterprise data while enforcing security, authorization, and data protection controls.',
          'Semantic Retrieval: Implement semantic search and retrieval capabilities that identify relevant information based on meaning, context, intent, and relationships rather than simple keyword matching.',
          'Contextual Knowledge Bots: Build intelligent knowledge interfaces capable of understanding user context and delivering relevant, grounded responses from enterprise information sources.',
          'Knowledge Grounding: Establish data and retrieval mechanisms that anchor AI outputs to authoritative enterprise information and reduce unsupported or contextually inaccurate responses.',
          'Enterprise Search Intelligence: Transform enterprise search into an intelligent discovery layer capable of understanding natural-language queries, synthesizing information, and surfacing relevant organizational knowledge.',
        ],
      },
      {
        title: 'AI Information & Document Intelligence',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Transform unstructured enterprise information into structured, searchable, contextual, and actionable intelligence using Generative AI and intelligent information processing.',
        items: [
          'AI-Powered Document Intelligence: Analyze complex document repositories to extract information, understand content, identify relationships, classify records, and generate contextual summaries.',
          'Intelligent Information Extraction: Extract structured information, entities, attributes, relationships, and business signals from unstructured and semi-structured enterprise content.',
          'Document Classification: Automatically classify enterprise documents according to content, business context, document type, metadata, regulatory requirements, and organizational taxonomies.',
          'Content Understanding: Apply AI to interpret the semantic structure, meaning, relationships, and context contained within enterprise documents and information assets.',
          'Document Summarization: Generate concise, context-aware summaries of complex documents while preserving critical information and organizational context.',
          'Knowledge Extraction: Convert unstructured information into reusable knowledge assets that can support enterprise search, analytics, decision-making, automation, and AI applications.',
        ],
      },
      {
        title: 'AI Insights & Decision Intelligence',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Combine Generative AI, analytics, predictive intelligence, and enterprise data to transform information into contextual insights and decision support.',
        items: [
          'Conversational BI: Enable users to interact with business intelligence through natural language, query enterprise data, explore metrics, investigate trends, and obtain contextual answers.',
          'Executive AI Reporting: Automate the synthesis of enterprise performance information into executive-level reports, summaries, insights, exceptions, and decision-support intelligence.',
          'Predictive Analytics with GenAI: Combine predictive models with Generative AI to explain analytical outputs, contextualize predictions, synthesize findings, and enable natural-language interaction with analytical systems.',
          'AI-Driven Strategic Dashboards: Develop intelligent dashboards that surface business trends, anomalies, operational signals, and recommendations while providing contextual interpretation.',
          'Decision Intelligence: Apply AI and analytics to support complex business decisions by combining data, predictions, contextual reasoning, business rules, and relevant organizational knowledge.',
          'Natural-Language Analytics: Enable business users to explore enterprise datasets, metrics, and analytical outputs using natural-language interaction rather than traditional analytical interfaces alone.',
        ],
      },
      {
        title: 'Content & Communication AI',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Automate enterprise content creation, transformation, personalization, localization, and knowledge distribution across business functions and communication channels.',
        items: [
          'Automated Content Generation: Design AI-powered workflows for generating business content across marketing, documentation, communications, knowledge management, and operational processes.',
          'Hyper-Personalized Content: Generate contextually relevant content tailored to customer segments, personas, channels, campaigns, and business contexts while maintaining organizational standards.',
          'Enterprise Translation & Localization: Enable scalable multilingual content transformation while maintaining terminology, contextual meaning, cultural relevance, and organizational brand consistency.',
          'AI Knowledge Publishing: Automate the creation, enrichment, maintenance, and distribution of enterprise knowledge across organizational repositories and communication channels.',
          'Content Transformation: Transform existing enterprise content into new formats, structures, summaries, narratives, and knowledge assets for different business and operational requirements.',
          'Intelligent Communications: Apply AI to personalize, automate, contextualize, and optimize enterprise communications across internal and external stakeholder interactions.',
        ],
      },
      {
        title: 'Product & Experience AI',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Embed Generative AI directly into digital products, enterprise applications, platforms, and user experiences to create intelligent, adaptive, and context-aware interactions.',
        items: [
          'GenAI Feature Engineering: Design and integrate Generative AI capabilities directly into digital products and applications to introduce intelligent functionality.',
          'AI Copilots for SaaS: Build embedded AI copilots that assist users with workflows, information discovery, content generation, analysis, recommendations, and task execution.',
          'AI-Enabled UX: Design user experiences that leverage AI to understand intent, context, and interaction patterns while simplifying complex workflows.',
          'Conversational Interfaces: Develop natural-language interfaces that allow users to interact with applications, services, data, and workflows through conversational interaction.',
          'Intelligent Product Experiences: Create adaptive product experiences that use AI to personalize interactions, surface relevant information, automate tasks, and improve user outcomes.',
          'Industry-Specific AI Accelerators: Develop reusable AI components, workflows, architectures, and solution modules tailored to specific industries and business domains.',
        ],
      },
      {
        title: 'GenAI Application Engineering',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Engineer production-grade Generative AI applications and intelligent workflows that integrate foundation models with enterprise systems, data, applications, and business processes.',
        items: [
          'GenAI Application Development: Design and engineer production-ready applications built around Generative AI capabilities and enterprise requirements.',
          'Model & API Integration: Integrate foundation models, AI services, enterprise APIs, applications, data sources, and external tools into cohesive AI solutions.',
          'Prompt Engineering: Design structured prompting strategies that improve model behavior, task performance, consistency, and contextual accuracy.',
          'Context Engineering: Engineer the information, memory, instructions, tools, and context supplied to AI systems to improve reasoning and task execution.',
          'AI Workflow Engineering: Design intelligent workflows that connect AI reasoning with business rules, enterprise applications, human approvals, and automated actions.',
          'Enterprise System Integration: Integrate GenAI applications with CRM, ERP, ITSM, data platforms, APIs, databases, business applications, and existing enterprise technology environments.',
        ],
      },
      {
        title: 'AI Data & Knowledge Engineering',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Engineer the data, knowledge, retrieval, and processing foundations required to support reliable, scalable, and context-aware enterprise AI systems.',
        items: [
          'Data & Pipeline Engineering: Design and implement reliable pipelines for acquiring, transforming, validating, enriching, and delivering data to AI systems.',
          'AI Data Preparation: Prepare enterprise datasets for AI applications through cleansing, normalization, transformation, enrichment, and quality validation.',
          'Knowledge Engineering: Structure enterprise knowledge into reusable representations that support retrieval, reasoning, search, automation, and AI applications.',
          'Vector Data Architecture: Design vector data architectures that support semantic retrieval, similarity search, knowledge discovery, and large-scale AI applications.',
          'Data Grounding: Establish mechanisms that connect AI systems to authoritative enterprise information and ensure responses are grounded in relevant organizational data.',
          'Retrieval Infrastructure: Engineer scalable retrieval infrastructure supporting semantic search, indexing, ranking, context assembly, and enterprise knowledge access.',
        ],
      },
      {
        title: 'GenAI Quality, Evaluation & Reliability',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Establish engineering frameworks that continuously measure, validate, and improve the accuracy, safety, reliability, resilience, and performance of GenAI systems.',
        items: [
          'Quality Assurance & Testing: Establish testing frameworks covering functional behavior, model outputs, integrations, workflows, security controls, and production readiness.',
          'Model & System Evaluation: Evaluate AI models and complete AI systems against defined quality, accuracy, safety, performance, and business effectiveness criteria.',
          'Benchmarking: Measure AI systems against standardized internal and external benchmarks to establish performance baselines and identify areas for improvement.',
          'Risk & Anomaly Detection: Detect abnormal behavior, unexpected outputs, quality degradation, system anomalies, and emerging operational risks.',
          'Continuous Evaluation: Continuously assess AI behavior and system performance throughout production operations to identify degradation and maintain quality over time.',
          'Resilience & Reliability: Engineer fault tolerance, recovery mechanisms, redundancy, and operational safeguards to maintain AI service availability and continuity.',
        ],
      },
      {
        title: 'Responsible AI & Governance',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Establish governance frameworks that ensure enterprise AI systems operate responsibly, transparently, explainably, and accountably throughout their lifecycle.',
        items: [
          'Responsible AI Frameworks: Define principles, standards, controls, and governance mechanisms for the responsible development and deployment of AI systems.',
          'AI Governance: Establish governance structures, decision authorities, policies, controls, and oversight mechanisms for enterprise AI.',
          'Fairness & Transparency: Implement mechanisms that promote equitable outcomes, transparency of system behavior, and visibility into AI-driven processes.',
          'Explainable AI: Enable authorized stakeholders to understand model behavior, decision pathways, outputs, limitations, and relevant contributing factors.',
          'Human-in-the-Loop Controls: Integrate human review, approval, intervention, and escalation mechanisms into AI workflows where human judgment is required.',
          'Accountability & Oversight: Establish ownership, responsibility, approval structures, escalation paths, and oversight mechanisms across the AI lifecycle.',
        ],
      },
      {
        title: 'AI Security, Trust & Compliance',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Protect AI systems, models, applications, infrastructure, and enterprise information while addressing security, privacy, regulatory, and organizational requirements.',
        items: [
          'AI Security Architecture: Design secure AI architectures incorporating zero-trust principles, layered controls, protected system boundaries, and enterprise security requirements.',
          'Threat & Prompt-Injection Defense: Protect AI systems against malicious inputs, prompt injection, unauthorized behavior, data leakage, model abuse, and AI-specific attack vectors.',
          'Identity & Access Management: Enforce authentication, authorization, role-based access, identity governance, and least-privilege controls across users, agents, applications, and systems.',
          'Data Privacy & Protection: Implement controls for sensitive information handling, privacy preservation, data protection, anonymization, and secure enterprise data usage.',
          'Regulatory Compliance: Align AI solutions with applicable regulatory requirements, industry obligations, organizational policies, and AI governance standards.',
          'Audit & Policy Enforcement: Maintain auditable evidence of system activity, policy enforcement, approvals, controls, governance decisions, and compliance activities.',
        ],
      },
      {
        title: 'AI Lifecycle, MLOps & LLMOps',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Operationalize the complete AI lifecycle through controlled development, deployment, versioning, monitoring, optimization, and continuous improvement.',
        items: [
          'AI Lifecycle Management: Govern AI systems from development and validation through deployment, production operation, maintenance, evolution, and retirement.',
          'Model & Prompt Versioning: Maintain controlled versions and lineage across models, prompts, configurations, datasets, workflows, and related AI assets.',
          'Deployment & Release Governance: Establish controlled deployment processes with validation requirements, approval checkpoints, release gates, rollback mechanisms, and production controls.',
          'MLOps / LLMOps: Operationalize machine learning and large language model environments through automation, monitoring, evaluation, deployment management, and continuous optimization.',
          'Model & System Monitoring: Monitor AI models and systems for performance, behavior, quality, usage, latency, reliability, and operational health.',
          'AI Asset Registry: Maintain centralized inventories of models, prompts, datasets, applications, configurations, ownership, documentation, lifecycle status, and governance metadata.',
          'Continuous Improvement: Establish feedback, evaluation, optimization, retraining, and refinement mechanisms to continuously improve AI system performance and business effectiveness.',
        ],
      },
      {
        title: 'AI Observability & Operations',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Provide continuous operational visibility, control, optimization, and management across enterprise AI environments and production workloads.',
        items: [
          'Full-Stack AI Observability: Monitor AI systems across applications, models, agents, workflows, infrastructure, data pipelines, latency, throughput, errors, and service health.',
          'Operational Monitoring: Track service availability, response times, resource utilization, workload behavior, system health, and operational performance.',
          'AI Cost & Token Optimization: Analyze model usage, token consumption, infrastructure utilization, workload patterns, and resource economics to optimize AI operating costs.',
          'Incident Management: Detect, investigate, prioritize, resolve, and recover from AI-related incidents while minimizing operational disruption.',
          'Capacity Management: Assess workload requirements and optimize infrastructure capacity to support enterprise AI workloads while maintaining performance and efficiency.',
          'Performance Analytics: Analyze operational and system performance to identify trends, bottlenecks, degradation, optimization opportunities, and service improvements.',
          'SLA & Operational Reporting: Deliver operational dashboards, service-level reporting, reliability metrics, performance indicators, and executive visibility across AI environments.',
        ],
      }
    ],
  },
