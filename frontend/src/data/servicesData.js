    ...
    capabilityAreas: [
      {
        ...
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Engineer production-grade machine learning systems that transform enterprise data into predictive intelligence, automated insights, and continuously improving models.',
        items: [
          'Predictive Intelligence: Develop predictive models that anticipate customer behavior, demand, operational conditions, financial outcomes, risks, and other future business events using historical and real-time enterprise data.',
          'Statistical Learning: Apply statistically rigorous methods to identify patterns, quantify uncertainty, model relationships, and generate evidence-based insights for complex business and operational decisions.',
          'Deep Learning Systems: Engineer advanced neural network architectures for complex recognition, classification, forecasting, representation learning, and other high-dimensional AI workloads.',
          'Feature Engineering: Design, transform, select, and optimize data features that improve model accuracy, robustness, interpretability, and business relevance.',
          'Model Optimization: Continuously improve model accuracy, efficiency, scalability, latency, and inference performance through systematic tuning, validation, and optimization.',
          'Model Monitoring: Monitor production models for accuracy, drift, bias, reliability, performance, and operational health throughout the AI lifecycle.',
        ],
      },
      {
        title: 'Decision Intelligence',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Transform analytical and predictive intelligence into actionable recommendations that help organizations make faster, more informed, and more consistent decisions.',
        items: [
          'Prescriptive Analytics: Determine recommended actions by combining predicted outcomes with business objectives, constraints, policies, and operational conditions.',
          'Decision Optimization: Evaluate competing alternatives and identify decisions that maximize business value while balancing cost, risk, resources, and operational constraints.',
          'Scenario Intelligence: Model alternative scenarios and simulate potential outcomes to support strategic planning, forecasting, risk assessment, and operational decision-making.',
          'Next-Best-Action: Determine the most appropriate action for a given customer, employee, operational condition, or business situation based on context and predicted outcomes.',
          'Intelligent Recommendations: Generate context-aware recommendations across products, services, operations, customer interactions, and enterprise workflows.',
          'Decision Support Systems: Embed AI-driven insights, recommendations, scenarios, and decision logic directly into enterprise applications and operational workflows.',
        ],
      },
      {
        title: 'Computer Vision & Visual Intelligence',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Enable enterprise systems to perceive, interpret, and reason over images, video, documents, and physical environments.',
        items: [
          'Image Intelligence: Extract structured information, patterns, and contextual insights from photographs, scanned documents, satellite imagery, medical imagery, industrial assets, and other visual datasets.',
          'Video Analytics: Analyze live and recorded video streams to detect events, identify activities, monitor environments, and support automated operational workflows.',
          'Object Recognition: Detect, classify, identify, and track physical objects across diverse visual environments and operational scenarios.',
          'Facial Analytics: Support face detection, identification, verification, and behavioral analysis for approved enterprise security, identity, and operational applications with appropriate privacy and compliance controls.',
          'Optical Character Recognition (OCR): Convert printed, handwritten, and scanned content into structured, searchable, and machine-readable enterprise information.',
          'Scene Intelligence: Understand complete visual environments by analyzing spatial relationships, activities, objects, movement, and contextual conditions.',
          'Visual Search: Enable image-based and semantic visual discovery across enterprise media repositories, product catalogs, documents, and visual knowledge bases.',
        ],
      },
      {
        title: 'Natural Language & Knowledge Intelligence',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Enable enterprise systems to understand, interpret, retrieve, connect, and reason over human language, documents, and organizational knowledge.',
        items: [
          'Conversational AI: Engineer intelligent conversational systems and AI assistants capable of context-aware interactions across customer, employee, service, and enterprise use cases.',
          'Language Understanding: Interpret intent, sentiment, entities, context, relationships, and meaning across structured and unstructured language interactions.',
          'Document Intelligence: Classify, analyze, summarize, extract, validate, and process enterprise documents at scale.',
          'Information Extraction: Identify entities, relationships, facts, attributes, and business-critical information from unstructured and semi-structured content.',
          'Speech Intelligence: Convert spoken communication into structured information through speech recognition, transcription, language analysis, and voice-based intelligence.',
          'Enterprise Search & Retrieval: Enable semantic and contextual discovery across enterprise knowledge repositories, documents, applications, and information systems.',
          'Knowledge Intelligence: Connect enterprise information, relationships, context, and institutional knowledge into intelligent knowledge systems that improve discovery, reasoning, and organizational decision-making.',
        ],
      },
      {
        title: 'Multimodal Intelligence',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Build AI systems capable of understanding and reasoning across multiple forms of information rather than treating each data modality independently.',
        items: [
          'Multimodal Understanding: Interpret multiple data modalities simultaneously to establish a more complete understanding of complex enterprise situations.',
          'Vision-Language Intelligence: Combine visual and language understanding to analyze images, documents, video, and visual environments using natural language reasoning.',
          'Multimodal Search: Enable users to discover enterprise information using combinations of text, images, documents, audio, and other data types.',
          'Cross-Modal Retrieval: Connect related information across different media and data formats to surface relevant enterprise knowledge and context.',
          'Multimodal Reasoning: Reason across multiple information sources and modalities to generate contextual insights, explanations, and recommendations.',
          'Multimodal AI Applications: Engineer enterprise applications that interact intelligently across language, vision, audio, documents, and structured business data.',
        ],
      },
      {
        title: 'Anomaly, Event & Edge Intelligence',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Detect emerging conditions, operational deviations, behavioral changes, and significant events as they occur, including where intelligence has to run close to the source of the data.',
        items: [
          'Anomaly Detection: Identify deviations from expected patterns across transactions, systems, machines, processes, customers, and operational environments.',
          'Event Detection: Identify meaningful events and conditions from structured data, unstructured information, sensor streams, audio, video, and other real-time signals.',
          'Behavioral Intelligence: Analyze changes in customer, employee, machine, system, and operational behavior to identify emerging patterns and conditions.',
          'Risk Signal Detection: Identify early indicators of operational, financial, compliance, security, and business risk from distributed enterprise signals.',
          'Edge AI: Deploy AI capabilities closer to where data is generated to support low-latency, resilient, privacy-aware, and bandwidth-efficient intelligence.',
          'Edge Inference: Run optimized AI models directly on devices, cameras, machines, sensors, and edge infrastructure.',
          'Real-Time Perception: Enable machines and intelligent systems to interpret their physical and operational environments with minimal latency.',
        ],
      },
      {
        title: 'Audio & Speech Intelligence',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Extract actionable intelligence from spoken communication and non-speech audio across customer interactions, operational environments, media, and connected systems.',
        items: [
          'Speech Recognition: Convert spoken language into accurate, structured, and searchable digital information.',
          'Voice Analytics: Analyze conversations and voice interactions to identify intent, sentiment, patterns, trends, and operational insights.',
          'Audio Classification: Identify and classify sounds, acoustic events, and environmental signals across real-time and recorded audio.',
          'Speaker Intelligence: Identify and distinguish speakers while enabling speaker-level analysis across authorized enterprise applications.',
          'Acoustic Event Detection: Detect meaningful sounds and acoustic events such as alerts, equipment conditions, operational anomalies, and environmental changes.',
        ],
      },
      {
        title: 'Extended Reality & Spatial Computing',
        image: '/images/capabilities/agentic-governed-autonomy.png',
        desc: 'Create immersive digital experiences that connect people, products, data, and physical environments.',
        items: [
          'Augmented Reality Solutions: Overlay contextual digital information onto physical environments to enhance operational workflows, field services, training, maintenance, and user experiences.',
          'Virtual Reality Experiences: Create immersive environments for simulation, training, collaboration, product demonstrations, and experiential learning.',
          'Mixed Reality Applications: Combine physical and digital environments to enable interactive experiences between people, enterprise information, intelligent systems, and physical assets.',
          'Digital Twin Visualization: Create interactive digital representations of physical assets, facilities, systems, and operations for monitoring, analysis, simulation, and optimization.',
          'Spatial Computing: Enable intelligent interaction between people, digital information, machines, and physical environments through spatial awareness and context.',
          'Immersive Product Demonstrations: Enable customers, engineers, and stakeholders to explore products, infrastructure, facilities, and solutions virtually before deployment or purchase.',
          'Industrial Simulation: Model manufacturing, logistics, engineering, infrastructure, and operational environments to evaluate scenarios, optimize performance, reduce risk, and improve planning.',
        ],
      },
    ],
