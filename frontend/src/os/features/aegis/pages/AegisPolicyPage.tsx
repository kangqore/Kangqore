  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 text-slate-500 text-sm">No policies loaded.</div>
      ) : (
        <div className="space-y-3">
          {policies.map((p: any) => (
            <div key={p.id} className="bg-white/[0.03] border border-white/10 hover:border-white/20 rounded-xl p-4 transition-all">
