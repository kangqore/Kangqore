...
export function EnterpriseTrustView() {
  return (
    <div className="max-w-6xl mx-auto space-y-12 pb-24">
      {/* HEADER */}
      <div>
        <h1 className="text-3xl font-extrabold text-[var(--os-text-1)] tracking-tight">Enterprise Trust Center</h1>
        <p className="mt-2 text-base text-[var(--os-text-2)] max-w-2xl">
          ...
          Our strategic differentiator is <strong>Governance by Execution</strong> — we don't just show dashboards; we audit every single action the AI takes.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-bold text-[var(--os-text-1)] tracking-wide">Security Roadmap</h2>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            <Settings2 className="w-5 h-5 text-[#e2445c]" />
      ...
      <section className="space-y-6 pt-8 border-t border-[var(--os-border)]">
        <div>
          <h2 className="text-2xl font-extrabold text-[var(--os-text-1)] tracking-tight">Governance by Execution</h2>
          <p className="mt-2 text-sm text-[var(--os-text-2)] max-w-3xl">
            Every AI action produces an immutable 9-point execution log. We track who acted, what was changed, the authority used, and the exact policy boundaries enforced.
          </p>
        </div>
