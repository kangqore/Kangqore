  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4 mb-2">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-os-cyan tracking-tight">OKRs — {selectedQuarter}</h2>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        {[
          ...
          return (
            <div key={s.status} className="flex items-center gap-2 px-4 py-2 bg-slate-900/40 backdrop-blur-2xl saturate-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.15),0_8px_32px_rgba(0,0,0,0.3)] ring-1 ring-white/10 border border-white/10 border-t-white/20/80 rounded-2xl text-xs shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
      ...
      <div className="flex items-center gap-4 flex-wrap pt-2">
        ...
        <select
          ...
          className="h-10 rounded-xl border border-white/10 border-t-white/20 bg-slate-900/40 backdrop-blur-2xl saturate-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.15),0_8px_32px_rgba(0,0,0,0.3)] ring-1 ring-white/10 text-sm text-slate-300 pl-4 pr-10 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100/50 shadow-sm"
        >
