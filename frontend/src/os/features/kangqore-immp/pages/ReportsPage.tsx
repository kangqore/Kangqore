    ...
    <div className="bg-[#151C2F] border border-[#2E2854] rounded-xl shadow-sm overflow-hidden">
      <div className="p-4 space-y-3">
        ...
        {report.sections?.length > 0 && expanded && (
          <div className="ml-11 space-y-4 pt-3 border-t border-[#2E2854]">
          ...
          return (
            <div key={rt.type} className={`border rounded-xl p-4 transition-all ${rt.color}`}>
              <div className="flex items-start gap-3 mb-3">
                <div className="w-8 h-8 rounded-lg bg-[#151C2F]/60 flex items-center justify-center flex-shrink-0">
              ...
              <button
                ...
                disabled={!!generating}
                className="flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-[#151C2F]/70 text-xs font-bold hover:bg-[#151C2F]/90 transition-colors disabled:opacity-50 border border-current/20"
              >
