  ...
  return (
    <div className="rounded-xl border border-[var(--os-border)] bg-[var(--os-card)] p-4 space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-center">
        <div className="rounded-lg bg-[var(--os-surface-0)] border border-[var(--os-border)] px-2 py-1.5">
...
function DirectivePanel() {
  ...
  const selectCls = 'w-full rounded-lg border border-[var(--os-border)] bg-[var(--os-surface-0)] text-[var(--os-text-1)] text-sm px-3 py-2 outline-none focus:ring-1 focus:ring-[var(--os-blue)]'
  ...
  return (
    <div className="rounded-xl border border-[var(--os-border)] bg-[var(--os-card)] p-5 space-y-4">
      ...
      <div className="space-y-1">
        ...
        <textarea
          className="w-full rounded-lg border border-[var(--os-border)] bg-[var(--os-surface-0)] text-[var(--os-text-1)] text-xs font-mono px-3 py-2 h-20 resize-none outline-none focus:ring-1 focus:ring-[var(--os-blue)]"
          value={payload}
      ...
      <div className="space-y-1">
        ...
        <input
          className="w-full rounded-lg border border-[var(--os-border)] bg-[var(--os-surface-0)] text-[var(--os-text-1)] text-sm px-3 py-2 outline-none focus:ring-1 focus:ring-[var(--os-blue)]"
          value={reason}
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--os-blue)] text-white text-sm font-semibold disabled:opacity-50 hover:opacity-90 transition-opacity"
      >
      ...
      {result && (
        <pre className="text-[10px] font-mono rounded-lg bg-[var(--os-surface-0)] border border-[var(--os-border)] p-3 overflow-x-auto text-[var(--os-text-2)] max-h-40">
          {result}
        </pre>
      )}
    </div>
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <div className="rounded-xl border border-[var(--os-border)] bg-[var(--os-card)] px-4 py-2 text-center">
