    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <Card key={c.label} className="hover:border-white/10 border-t-white/20/80 transition-all duration-200">
            <p className="text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1">{c.label}</p>
            <p className="text-2xl font-bold tracking-tight text-slate-200">{c.value}</p>
          </Card>
        ))}
      </div>
