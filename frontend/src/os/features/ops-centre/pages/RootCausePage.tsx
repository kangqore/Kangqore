...
const CLUSTERS: Cluster[] = [
  ...
  },
  {
    ...
    kimmpConfidence: 100,
    rootCause: 'The 90-day access review cycle was not enforced due to the absence of automated scheduling. 12 accounts exceeded the review window, triggering an HANUMANAS SOC 2 control violation flag. Root cause is a process gap, not a security incident.',
