...
const ISSUES: Issue[] = [
  ...
  },
  {
    ...
    summary: '12 user accounts have not had access reviewed in 91 days, exceeding the 90-day SOC 2 control requirement. HANUMANAS flagged this automatically.',
    domain: 'Compliance',
    entity: 'HANUMANAS',
    severity: 'P2',
    status: 'open',
    kimmpConfidence: 100,
    kimmpAction: 'Complete access review for all 12 users before end of day. Document review in HANUMANAS audit log.',
