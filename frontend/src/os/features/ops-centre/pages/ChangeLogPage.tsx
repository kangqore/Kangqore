...
const CHANGES: Change[] = [
  ...
  {
    id: 'CHG-044',
    title: 'HANUMANAS: implement automated 85-day access review reminder',
    type: 'IT',
    status: 'in-progress',
    riskScore: 6,
    raisedBy: 'System Auto-raised',
    affectedEntities: ['HANUMANAS', 'IT Admin'],
  ...
  },
  {
    ...
    riskScore: 24,
    raisedBy: 'Ravi Kumar',
    affectedEntities: ['Infrastructure', 'HANUMANAS'],
    summary: 'Security patching cycle completed on schedule. All 12 nodes updated. HANUMANAS patch compliance control now passing.',
