      ...
      <div className="w-full max-w-md rounded-2xl border border-[var(--os-border)] bg-[var(--os-card)] p-5 space-y-4">
        ...
        <div>
          ...
          {searchData?.objects && searchData.objects.length > 0 && !targetId && (
            <div className="mt-1 rounded-2xl border border-[var(--os-border)] bg-[var(--os-surface-0)] max-h-40 overflow-y-auto">
      ...
      <td colSpan={6} className="bg-[var(--os-surface-0)] border-b border-[var(--os-border)]">
          ...
          <div>
            ...
            {relsLoading ? (
              ...
              <div className="space-y-1.5">
                {rels.map((r: any) => (
                  <div key={r.id} className="flex items-center gap-2 px-3 py-2 rounded-2xl border border-[var(--os-border)] bg-[var(--os-card)] text-xs">
            ...
            <div className="flex flex-wrap gap-2">
              {actions.map((a: OntologyAction) => (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-2xl border border-[var(--os-border)] bg-[var(--os-card)] text-xs font-semibold text-[var(--os-text-2)] hover:text-[#579bfc] hover:border-[#579bfc]/40 transition-colors"
                >
        ...
        {activity.length > 0 && (
          <div className="px-8 pb-4">
            ...
            <div className="space-y-1.5">
              {activity.map((e: any) => (
                <div key={e.id} className="flex items-center gap-2 px-3 py-2 rounded-2xl border border-[var(--os-border)] bg-[var(--os-card)] text-xs">
                  <span
          ...
          <div className="px-8 pb-4">
            ...
            <div className="flex flex-wrap gap-4">
              {Object.entries(series).map(([propertyName, points]) => (
                <div key={propertyName} className="px-3 py-2 rounded-2xl border border-[var(--os-border)] bg-[var(--os-card)]">
      ...
      {types.length > 0 && (
        <div className="flex items-center gap-1.5 flex-wrap">
          <button
            ...
            className={cn(
              'px-3 py-1.5 rounded-2xl text-[11px] font-semibold transition-all border',
              !typeId
