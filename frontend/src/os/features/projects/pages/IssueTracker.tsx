  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          {[
            ...
            { label: `${open} Open`,         color: 'bg-slate-900 text-slate-300 border-white/10 border-t-white/20' },
          ].map(c => (
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <span className="ml-auto text-sm text-slate-500">{visible.length} issues</span>
      </div>
                ...
                <tr key={issue.id} className="hover:bg-slate-900 transition-colors cursor-pointer group">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-slate-200 group-hover:text-blue-700 transition-colors">{issue.title}</span>
                  ...
                  <td className="px-4 py-3">
                    <span className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs capitalize text-slate-500">{issue.priority}</span>
                    </span>
                  </td>
                  <td className="px-4 py-3">
