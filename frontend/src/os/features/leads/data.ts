...
export const LEADS: Lead[] = [
  ...
  // ── Strategic Enterprise Pipeline (Indian Enterprise) ─────────────────────
  { id: 'l13', company: 'Birla Digital Labs',   contactName: 'Aditya Birla',     contactRole: 'Chief Digital Officer', email:'aditya@birladigitallabs.in', phone: '+91 98765 43210', country: 'India',       industry: 'Enterprise / Conglomerate', stage: 'negotiation', source: 'referral', score: 95, value: 2500000, probability: 78, owner: 'Mahesh Kumar',  createdAt: '2026-06-01', lastActivity: '2026-07-10', tags: ['customer-one','enterprise-os','strategic','waanda'], description: 'Customer One target. Enterprise OS deployment — WAANDA + HANUMANAS full stack. Blueprint Wizard ready.' },
  { id: 'l14', company: 'HDFC Bank Digital',    contactName: 'Ritu Sharma',      contactRole: 'EVP Digital Banking',   email:'ritu.sharma@hdfcbank.com',   phone: '+91 22 6652 1000',country: 'India',       industry: 'Financial Services / Banking', stage: 'proposal', source: 'outbound', score: 88, value: 18000000, probability: 62, owner: 'Mahesh Kumar',  createdAt: '2026-06-15', lastActivity: '2026-07-14', tags: ['customer-two','fintech-pack','banking','npa'],    description: 'Customer Two target. FinTech Pack deployment — NPA monitoring, fraud detection, regulatory reporting OS.' },
  { id: 'l15', company: 'Bajaj Finserv',        contactName: 'Vikram Mehta',     contactRole: 'CTO',                   email:'vikram.mehta@bajajfinserv.in',phone: '+91 20 3898 9999',country: 'India',       industry: 'Financial Services / NBFC',  stage: 'qualified', source: 'outbound', score: 76, value: 12000000, probability: 48, owner: 'Mahesh Kumar',  createdAt: '2026-07-01', lastActivity: '2026-07-15', tags: ['fintech-pack','cross-sell','cltv','intelligence'], description: 'Qualifying FinTech Pack interest. CLTV + cross-sell agents are key hooks across 14M customer base.' },
]
