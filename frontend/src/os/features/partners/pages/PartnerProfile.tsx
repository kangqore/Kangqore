...
const TIER_STYLE: Record<PartnerTier, string> = {
  ...
  silver:   'bg-[#151C2F] text-slate-300',
  associate:'bg-[#0F172A]  text-slate-300',
}
...
const NOTE_COLOR: Record<PartnerNote['type'], string> = {
  ...
  performance: 'bg-amber-100 text-amber-600', general: 'bg-[#151C2F] text-slate-300',
}
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <div className="flex items-center gap-3 mt-4 pt-4 border-t border-[#2E2854]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <div className="space-y-3">
            {deliverables.map(d => (
              <div key={d.id} className="p-3 rounded-xl bg-[#0F172A] border border-[#2E2854]">
                ...
                {d.feedback && (
                  <p className="text-xs text-slate-500 mt-1.5 italic border-l-2 border-[#2E2854] pl-2">{d.feedback}</p>
                )}
      ...
      <Card>
        ...
        <div className="space-y-2">
          {payments.map(p => (
            <div key={p.id} className="flex items-center gap-4 py-2.5 border-b border-[#2E2854] last:border-0">
        ...
        <div className="mt-4 pt-4 border-t border-[#2E2854] flex items-center justify-between">
