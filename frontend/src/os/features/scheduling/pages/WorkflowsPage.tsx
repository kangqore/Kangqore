                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input type="number" min={1} value={form.offsetValue} onChange={e => set('offsetValue', Number(e.target.value))}
                      className="w-20 h-9 rounded-xl border border-os-border bg-os-s1 text-sm text-white px-3 focus:outline-none focus:border-blue-400" />
                    <select value={form.offsetUnit} onChange={e => set('offsetUnit', e.target.value)}
                      className="flex-1 h-9 rounded-xl border border-os-border bg-os-s1 text-sm text-white px-2 focus:outline-none focus:border-blue-400">
          ...
          <Card key={wf.id}>
            <CardBody className="p-4">
              <div className="flex items-center gap-4">
                <div className="w-8 h-8 rounded-xl bg-os-s1 flex items-center justify-center flex-shrink-0">
