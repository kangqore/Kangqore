...
export const RAIL_ITEMS: RailEntry[] = [
  ...
  },
  {
    ...
    sidebarItems: [
      ...
      { id: 'kimmp-krisnam-training', label: 'Krisnam Training',        path: `${BASE}/kangqore-immp/training`,              category: 'Execution & Ops' },
      { id: 'kimmp-krisnam-model',    label: 'Krisnam 0.1.1',          path: `${BASE}/kangqore-immp/krisnam-model`,         category: 'Execution & Ops', badge: 'new' },
      { id: 'kimmp-gen3',           label: 'Gen 3 Runtime',          path: `${BASE}/kangqore-immp/gen3`,                  category: 'Execution & Ops', badge: 'new' },
      { id: 'kimmp-krisnam-accuracy', label: 'Krisnam Accuracy',       path: `${BASE}/kangqore-immp/krisnam-accuracy`,       category: 'Execution & Ops', badge: 'new' },
  ...
  },
  {
    ...
    sidebarItems: [
      { id: 'hanumanas-overview',   label: 'Overview',   path: `${BASE}/hanumanas`,            category: 'Command' },
      { id: 'hanumanas-live',       label: 'Live Feed',  path: `${BASE}/hanumanas/live`,       category: 'Command' },
      { id: 'hanumanas-agents',     label: 'Agents',     path: `${BASE}/hanumanas/agents`,     category: 'Governance' },
      { id: 'hanumanas-compliance', label: 'Compliance', path: `${BASE}/hanumanas/compliance`, category: 'Governance' },
      { id: 'hanumanas-audit',      label: 'Audit',      path: `${BASE}/hanumanas/audit`,      category: 'Governance' },
      { id: 'hanumanas-policy',     label: 'Policy',     path: `${BASE}/hanumanas/policy`,     category: 'Governance' },
      { id: 'hanumanas-autonomy',     label: 'Autonomy',     path: `${BASE}/hanumanas/autonomy`,     category: 'Shield' },
      { id: 'hanumanas-assets',       label: 'Assets',       path: `${BASE}/hanumanas/assets`,       category: 'Shield' },
      { id: 'hanumanas-egress',       label: 'Egress',       path: `${BASE}/hanumanas/egress`,       category: 'Shield' },
      { id: 'hanumanas-shield',       label: 'Shield',       path: `${BASE}/hanumanas/shield`,       category: 'Shield' },
      { id: 'hanumanas-permissions',  label: 'Permissions',  path: `${BASE}/hanumanas/permissions`,  category: 'Shield' },
      { id: 'hanumanas-enforcement',  label: 'Enforcement',  path: `${BASE}/hanumanas/enforcement`,  category: 'Shield',      badge: 'new' },
      { id: 'hanumanas-findings',     label: 'Findings',     path: `${BASE}/hanumanas/findings`,     category: 'Governance',  badge: 'new' },
      { id: 'hanumanas-ai-security-view', label: 'AI Security View', path: `${BASE}/hanumanas/ai-security-view`, category: 'Governance', badge: 'new' },
    ],
  },
  {
    id: 'ontology',
    ...
    sidebarItems: [
      ...
      { id: 'ont-action-library', label: 'Action Library',  path: `${BASE}/ontology/action-library`, category: 'Actions', badge: 'new' },
      { id: 'ont-actions',        label: 'Actions',         path: `${BASE}/ontology/actions`,        category: 'Actions' },
      { id: 'ont-executions',     label: 'Execution Log',   path: `${BASE}/ontology/executions`,     category: 'Actions' },
