...
export const RAIL_ITEMS: RailEntry[] = [
  ...
  },
  {
    ...
    sidebarItems: [
      ...
      { id: 'kimmp-blueprint-wiz',  label: 'Blueprint Wizard',    path: `${BASE}/kangqore-immp/blueprint-customize`, category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-revenue-intel',  label: 'Revenue Intel',       path: `${BASE}/kangqore-immp/revenue-pipeline`,    category: 'Enterprise', badge: 'new' },
