...
export const RAIL_ITEMS: RailEntry[] = [
  ...
  },
  {
    ...
    sidebarItems: [
      ...
      { id: 'kimmp-customer-two',   label: 'Customer Two',         path: `${BASE}/kangqore-immp/customer-two`,        category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-three', label: 'Customer Three',       path: `${BASE}/kangqore-immp/customers/three`,     category: 'Enterprise', badge: 'new' },
      ...
      { id: 'kimmp-customer-six',        label: 'Customer Six',           path: `${BASE}/kangqore-immp/customers/six`,           category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-seven',      label: 'Customer Seven',         path: `${BASE}/kangqore-immp/customers/seven`,         category: 'Enterprise', badge: 'new' },
      ...
      { id: 'kimmp-customer-eleven',       label: 'Customer Eleven',           path: `${BASE}/kangqore-immp/customers/eleven`,             category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twelve',       label: 'Customer Twelve',           path: `${BASE}/kangqore-immp/customers/twelve`,             category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-thirteen',     label: 'Customer Thirteen',         path: `${BASE}/kangqore-immp/customers/thirteen`,           category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-fourteen',     label: 'Customer Fourteen',         path: `${BASE}/kangqore-immp/customers/fourteen`,           category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-fifteen',      label: 'Customer Fifteen',          path: `${BASE}/kangqore-immp/customers/fifteen`,            category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-sixteen',      label: 'Customer Sixteen',          path: `${BASE}/kangqore-immp/customers/sixteen`,            category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-seventeen',    label: 'Customer Seventeen',        path: `${BASE}/kangqore-immp/customers/seventeen`,          category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-eighteen',     label: 'Customer Eighteen',         path: `${BASE}/kangqore-immp/customers/eighteen`,           category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-nineteen',     label: 'Customer Nineteen',         path: `${BASE}/kangqore-immp/customers/nineteen`,           category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twenty',       label: 'Customer Twenty 🎯',        path: `${BASE}/kangqore-immp/customers/twenty`,             category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-20-milestone', label: 'C20 Milestone 🎯',          path: `${BASE}/kangqore-immp/customer-twenty-milestone`,    category: 'Enterprise', badge: 'new' },
      ...
      { id: 'kimmp-customer-twentyone',    label: 'C21 · Meridian Health',      path: `${BASE}/kangqore-immp/customers/twenty-one`,         category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twentytwo',    label: 'C22 · Veridian Clinic',      path: `${BASE}/kangqore-immp/customers/twenty-two`,         category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twentythree',  label: 'C23 · NovaCare',             path: `${BASE}/kangqore-immp/customers/twenty-three`,       category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twentyfour',   label: 'C24 · Apex Legal',           path: `${BASE}/kangqore-immp/customers/twenty-four`,        category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twentyfive',   label: 'C25 · Stellaris Law',        path: `${BASE}/kangqore-immp/customers/twenty-five`,        category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twentysix',    label: 'C26 · ClearPath',            path: `${BASE}/kangqore-immp/customers/twenty-six`,         category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twentyseven',  label: 'C27 · Orbis Capital',        path: `${BASE}/kangqore-immp/customers/twenty-seven`,       category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twentyeight',  label: 'C28 · Quantex Trading',      path: `${BASE}/kangqore-immp/customers/twenty-eight`,       category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-customer-twentynine',   label: 'C29 · PrismFX Payments',     path: `${BASE}/kangqore-immp/customers/twenty-nine`,        category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-vertical-gate-s140',    label: 'Gate S140 · 30 Customers',   path: `${BASE}/kangqore-immp/vertical-gate-s140`,           category: 'Enterprise', badge: 'new' },
      { id: 'kimmp-oem-portal',           label: 'OEM Portal v2',               path: `${BASE}/kangqore-immp/oem-portal`,                   category: 'OEM',        badge: 'new' },
      { id: 'kimmp-oem-branding',         label: 'OEM Branding Config',         path: `${BASE}/kangqore-immp/oem-branding`,                 category: 'OEM',        badge: 'new' },
      { id: 'kimmp-oem-persona',          label: 'OEM Persona Engine',          path: `${BASE}/kangqore-immp/oem-persona`,                  category: 'OEM',        badge: 'new' },
      { id: 'kimmp-oem-blueprints',       label: 'OEM Blueprint Packager',      path: `${BASE}/kangqore-immp/oem-blueprints`,               category: 'OEM',        badge: 'new' },
      { id: 'kimmp-oem-fleet',            label: 'OEM Sub-tenant Fleet',        path: `${BASE}/kangqore-immp/oem-fleet`,                    category: 'OEM',        badge: 'new' },
      { id: 'kimmp-oem-margin',           label: 'OEM Margin & Revenue',        path: `${BASE}/kangqore-immp/oem-margin`,                   category: 'OEM',        badge: 'new' },
      { id: 'kimmp-oem-partner-zero',     label: '⭐ Partner Zero (S147)',      path: `${BASE}/kangqore-immp/oem-partner-zero`,             category: 'OEM',        badge: 'new' },
      { id: 'kimmp-oem-gate-s148',        label: 'Gate S148 · OEM v1.0',        path: `${BASE}/kangqore-immp/oem-gate-s148`,                category: 'OEM',        badge: 'new' },
      { id: 'kimmp-uk-launch',            label: '🇬🇧 UK Commercial Launch',    path: `${BASE}/kangqore-immp/uk-launch`,                    category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-eu-launch',            label: '🇪🇺 EU Commercial Launch',    path: `${BASE}/kangqore-immp/eu-launch`,                    category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-india-launch',         label: '🇮🇳 India Commercial Launch', path: `${BASE}/kangqore-immp/india-launch`,                 category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-intl-personas',        label: 'Regional WAANDA Personas',    path: `${BASE}/kangqore-immp/intl-personas`,                category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-intl-analytics',       label: 'Regional Analytics',          path: `${BASE}/kangqore-immp/intl-analytics`,               category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-c30',                  label: 'C30 · Meridian Advisors',     path: `${BASE}/kangqore-immp/customers/thirty`,             category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-c31',                  label: 'C31 · Holloway Legal',        path: `${BASE}/kangqore-immp/customers/thirty-one`,         category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-c32',                  label: 'C32 · Eurotek Solutions',     path: `${BASE}/kangqore-immp/customers/thirty-two`,         category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-c33',                  label: 'C33 · NordVentures GmbH',    path: `${BASE}/kangqore-immp/customers/thirty-three`,       category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-c34',                  label: 'C34 · Infovanta Tech',        path: `${BASE}/kangqore-immp/customers/thirty-four`,        category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-c35',                  label: 'C35 · Spice Route Commerce',  path: `${BASE}/kangqore-immp/customers/thirty-five`,        category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-intl-gate-s157',       label: '⭐ Gate S157 · Intl GTM v1.0', path: `${BASE}/kangqore-immp/intl-gate-s157`,              category: 'Int\'l GTM', badge: 'new' },
      { id: 'kimmp-gen4-corpus',          label: 'Corpus Quality Audit',          path: `${BASE}/kangqore-immp/gen4-corpus`,                category: 'WAANDAx Gen4', badge: 'new' },
      { id: 'kimmp-gen4-dataset',         label: 'Dataset Export Pipeline',       path: `${BASE}/kangqore-immp/gen4-dataset`,               category: 'WAANDAx Gen4', badge: 'new' },
      { id: 'kimmp-gen4-training',        label: 'Training Jobs',                 path: `${BASE}/kangqore-immp/gen4-training`,              category: 'WAANDAx Gen4', badge: 'new' },
      ...
      { id: 'kimmp-ch9-gate-s170',        label: '⭐ Gate S170 · Chapter 9 Close',path: `${BASE}/kangqore-immp/ch9-gate-s170`,             category: 'Revenue Ops', badge: 'new' },
    ],
  },
  {
    id: 'keos',
...
export const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'kimmp-gateway',  label: 'Intelligence Gateway', icon: RadioIcon,     path: `${BASE}/kimmp-gateway`  },
