...
export function InnovServiceCentre() {
  return (
    <div className="px-6 lg:px-10 py-10 max-w-5xl mx-auto space-y-8">
      <div className="flex items-start gap-4">
        <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: '#CA8A0420' }}>
          <Headset className="w-6 h-6" style={{ color: '#CA8A04' }} />
        </div>
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white">Service Centre</h1>
          <p className="text-[var(--os-text-2)] mt-1 text-sm">Submit and track requests across all departments — powered by KIMMP.</p>
        </div>
      </div>
