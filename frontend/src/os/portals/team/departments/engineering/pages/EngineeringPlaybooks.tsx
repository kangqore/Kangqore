...
const TEMPLATES: PlaybookTemplate[] = [
  {
    ...
    steps: [
      ...
      { id: 's3', label: 'Diagnose Root Cause',            instructions: 'Check Monitoring dashboard, recent deployments (last 2h), HANUMANAS audit log, and DB metrics. Rule out each service.', assignee: 'Lead Engineer',      sla: '30m', status: 'PENDING', kimmHint: 'Email service is currently degraded — if incident is comms-related, check SMTP relay first.' },
