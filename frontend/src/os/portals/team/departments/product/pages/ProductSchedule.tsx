  ...
  return (
    <div className="px-6 lg:px-10 py-10 max-w-6xl mx-auto space-y-8">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white">Product Schedule</h1>
          <p className="text-[var(--os-text-2)] mt-1 text-sm">Weekly availability calendar with KIMMP sprint capacity forecasting.</p>
        </div>
      </div>
