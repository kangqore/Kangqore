...
export function TeamSidebar() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-orange-500 to-orange-400 flex items-center justify-center flex-shrink-0 shadow-sm">
        ...
        {!sidebarCollapsed && (
          <div className="overflow-hidden">
            ...
            <p className="text-orange-400 text-[10px] tracking-widest mt-0.5 font-bold uppercase">Team</p>
          </div>
        )}
      </Link>
