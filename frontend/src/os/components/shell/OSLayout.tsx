...
export function OSLayout() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden bg-slate-900 rounded-tl-2xl shadow-[0_0_15px_rgba(0,0,0,0.5)] m-0 md:my-2 md:mr-2 md:rounded-2xl border border-os-border">
        {!isWaandaGUI && <Topbar />}
        {isWaandaGUI ? (
          ...
          <main className="flex-1 overflow-y-auto px-6 py-6 lg:px-10 lg:py-8 pb-16 bg-slate-900">
            <PageTransition>
              <ModuleShell>
                <Outlet />
              </ModuleShell>
