    ...
    <section ref={containerRef} className="py-28 relative overflow-hidden bg-[#02050b]">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-[1fr_64px_1fr] gap-0 items-stretch relative">
                ...
                {comparisonTable.rows.map((row, i) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-3.5 rounded-xl transition-all duration-300 cursor-pointer ${
                        isHovered
                          ? 'bg-white/[0.06] border border-white/10 shadow-lg translate-x-1'
          ...
          {/* Centre divider with pulsing button & glowing laser connector */}
          <div className="hidden lg:flex flex-col items-center justify-center relative z-20">
            ...
            <div className="relative z-10 w-11 h-11 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 p-[1px] shadow-[0_0_28px_rgba(34,211,238,0.5)] animate-pulse">
          ...
          <div className="rounded-2xl lg:rounded-l-none bg-gradient-to-br from-[#06142a]/90 via-[#030a18]/95 to-[#020712]/95 backdrop-blur-md border border-cyan-400/30 lg:border-l-0 border-l-2 border-l-cyan-400/40 p-8 lg:p-10 shadow-[0_0_50px_rgba(34,211,238,0.12)] relative z-10 flex flex-col justify-between">
            <div>
                ...
                {comparisonTable.rows.map((row, i) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-3.5 rounded-xl transition-all duration-300 cursor-pointer ${
                        isHovered
                          ? 'bg-cyan-500/15 border border-cyan-400/30 shadow-[0_0_20px_rgba(34,211,238,0.2)] -translate-x-1'
