          ...
          <div className="grid lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1.1fr)] gap-20 lg:gap-16 items-start mb-20">
            ...
            {service.capabilityAreas ? (
              service.slug === 'agentic-ai-led-application-modernization' ? (
                ...
                <div className="flex items-center justify-start sm:justify-center w-full lg:-mt-16 overflow-x-auto sm:overflow-visible" role="group" aria-label="Grounded generation flow — corpus to retrieval, context, generation, guardrails, and either a cited answer or a refusal" tabIndex={0}>
                  <svg viewBox="0 0 540 420" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[95%] min-w-[460px] sm:min-w-0 ml-auto">
                    <title>How a grounded generative answer is produced</title>
                    <desc>Your documents are retrieved under the asking user&apos;s permissions, assembled into context, generated by a routed model, and checked by guardrails — returning either an answer with the passage it used, or a refusal when the corpus has nothing relevant.</desc>

                    <defs>
                      {/* objectBoundingBox gradient units are not rendered on an
                          element with zero width or height, and every connector
                          below is a straight line. */}
                      <linearGradient id="gen-spine" gradientUnits="userSpaceOnUse" x1="26" y1="176" x2="514" y2="176">
                        <stop offset="0" stopColor="#2564ea" />
                        <stop offset="1" stopColor="#4ab6d4" />
                      </linearGradient>
                      <linearGradient id="gen-stage" gradientUnits="userSpaceOnUse" x1="0" y1="150" x2="0" y2="202">
                        <stop offset="0" stopColor="#131d31" />
                        <stop offset="1" stopColor="#0a0f1a" />
                      </linearGradient>
                      <marker id="gen-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse">
                        <path d="M0,0 L10,5 L0,10 z" fill="#4ab6d4" />
                      </marker>
                      <marker id="gen-arrow-amber" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse">
                        <path d="M0,0 L10,5 L0,10 z" fill="#f59e0b" />
                      </marker>
                      <marker id="gen-tick" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="4" markerHeight="4" orient="auto-start-reverse">
                        <path d="M0,0 L10,5 L0,10 z" fill="#ffffff" fillOpacity="0.35" />
                      </marker>
                    </defs>

                    {/* ── Corpus ── */}
                    <text x="26" y="34" fontFamily="monospace" fontSize="12" fontWeight="bold" letterSpacing="1.6" fill="#4ab6d4">YOUR CORPUS</text>
                    <rect x="26" y="46" width="488" height="46" rx="9" fill="#0a1220" stroke="#4ab6d4" strokeOpacity="0.3" />
                    <text x="270" y="75" textAnchor="middle" fontFamily="monospace" fontSize="12" fill="white" fillOpacity="0.85">policies · tickets · transcripts · code · manuals</text>

                    <g stroke="#ffffff" strokeOpacity="0.2" strokeWidth="1" strokeDasharray="3 4" markerEnd="url(#gen-tick)">
                      <line x1="81" y1="94" x2="81" y2="146" />
                    </g>
                    <text x="92" y="126" fontFamily="monospace" fontSize="12" fill="white" fillOpacity="0.45">scoped to the asking user</text>

                    {/* ── The four stages ── */}
                    <line x1="26" y1="176" x2="514" y2="176" stroke="url(#gen-spine)" strokeWidth="2" strokeOpacity="0.45" />

                    <g fontFamily="monospace" textAnchor="middle">
                      <rect x="26" y="150" width="110" height="52" rx="9" fill="url(#gen-stage)" stroke="#2564ea" strokeOpacity="0.6" strokeWidth="1.5" />
                      <text x="81" y="172" fontSize="13" fontWeight="bold" letterSpacing="0.6" fill="white">RETRIEVE</text>
                      <text x="81" y="190" fontSize="12" fill="white" fillOpacity="0.55">top passages</text>

                      <rect x="152" y="150" width="110" height="52" rx="9" fill="url(#gen-stage)" stroke="#3080e6" strokeOpacity="0.6" strokeWidth="1.5" />
                      <text x="207" y="172" fontSize="13" fontWeight="bold" letterSpacing="0.6" fill="white">ASSEMBLE</text>
                      <text x="207" y="190" fontSize="12" fill="white" fillOpacity="0.55">context</text>

                      <rect x="278" y="150" width="110" height="52" rx="9" fill="url(#gen-stage)" stroke="#3b9ce0" strokeOpacity="0.6" strokeWidth="1.5" />
                      <text x="333" y="172" fontSize="13" fontWeight="bold" letterSpacing="0.6" fill="white">GENERATE</text>
                      <text x="333" y="190" fontSize="12" fill="white" fillOpacity="0.55">model routing</text>

                      <rect x="404" y="150" width="110" height="52" rx="9" fill="url(#gen-stage)" stroke="#4ab6d4" strokeOpacity="0.75" strokeWidth="1.5" />
                      <text x="459" y="172" fontSize="13" fontWeight="bold" letterSpacing="0.6" fill="white">GUARDRAILS</text>
                      <text x="459" y="190" fontSize="12" fill="white" fillOpacity="0.55">in and out</text>
                    </g>

                    <g stroke="#4ab6d4" strokeOpacity="0.55" strokeWidth="1.5" markerEnd="url(#gen-arrow)">
                      <line x1="138" y1="176" x2="149" y2="176" />
                      <line x1="264" y1="176" x2="275" y2="176" />
                      <line x1="390" y1="176" x2="401" y2="176" />
                    </g>

                    {/* ── Two outcomes ── */}
                    <path d="M 459 204 C 459 236, 300 236, 160 236 C 150 236, 145 242, 145 254" fill="none" stroke="#00c875" strokeOpacity="0.55" strokeWidth="1.5" markerEnd="url(#gen-arrow)" />
                    <path d="M 459 204 L 459 254" fill="none" stroke="#f59e0b" strokeOpacity="0.55" strokeWidth="1.5" strokeDasharray="5 4" markerEnd="url(#gen-arrow-amber)" />

                    <rect x="26" y="258" width="238" height="62" rx="9" fill="#08130d" stroke="#00c875" strokeOpacity="0.45" strokeWidth="1.5" />
                    <text x="145" y="282" textAnchor="middle" fontFamily="monospace" fontSize="13" fontWeight="bold" letterSpacing="0.6" fill="#00c875">ANSWER</text>
                    <text x="145" y="302" textAnchor="middle" fontFamily="monospace" fontSize="12" fill="white" fillOpacity="0.8">with the passage it used</text>

                    <rect x="340" y="258" width="174" height="62" rx="9" fill="#171208" stroke="#f59e0b" strokeOpacity="0.45" strokeWidth="1.5" />
                    <text x="427" y="282" textAnchor="middle" fontFamily="monospace" fontSize="13" fontWeight="bold" letterSpacing="0.6" fill="#f59e0b">REFUSE</text>
                    <text x="427" y="302" textAnchor="middle" fontFamily="monospace" fontSize="12" fill="white" fillOpacity="0.8">nothing relevant</text>

                    {/* ── Evaluation runs across the whole path ── */}
                    <rect x="26" y="346" width="488" height="44" rx="9" fill="#0a1220" stroke="#ffffff" strokeOpacity="0.14" />
                    <text x="270" y="373" textAnchor="middle" fontFamily="monospace" fontSize="12" fill="white" fillOpacity="0.6">evaluation runs on every prompt, index and model change</text>
                  </svg>
                </div>
              ) : service.slug === 'mlops' ? (
