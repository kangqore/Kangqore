...
import './PSEDRuler.css';

const NAV_ITEMS = [
  { id: 'psed-hero',         num: '01', label: 'Overview'      },
  { id: 'psed-what',         num: '02', label: 'What Is It'    },
  { id: 'psed-concierge',    num: '03', label: 'eQORE AI™'     },
  { id: 'psed-capabilities', num: '04', label: 'Capabilities'  },
  { id: 'psed-phases',       num: '05', label: 'Our Process'   },
  { id: 'psed-why',          num: '06', label: 'Why Kangqore'  },
  { id: 'psed-faq',          num: '07', label: 'FAQ'           },
];

export default function PSEDRuler() {
