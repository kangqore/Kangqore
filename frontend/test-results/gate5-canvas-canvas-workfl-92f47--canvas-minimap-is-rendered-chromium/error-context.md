...
- Name: gate5-canvas.spec.ts >> canvas: workflow canvas >> canvas: minimap is rendered
- Location: e2e/gate5-canvas.spec.ts:49:7
...
Locator: locator('.react-flow__minimap, [class*="minimap"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.react-flow__minimap, [class*="minimap"]').first()
